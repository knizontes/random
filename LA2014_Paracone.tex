...
ma si distingue da essa per alcuni dettagli funzionali e implementativi:
 ...
 \begin{enumerate}
   ...
   conoscere gli input;
   \item \textbf{pseudorandomicità:} non deve essere possibile predire i futuri
   output o conoscere lo stato interno a partire dalla conoscenza di output
   correnti, anche per un attaccante con una conoscenza parziale delle sorgenti
   di entropia;
